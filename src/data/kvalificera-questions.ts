...
export const questions: Question[] = [
  ...
  { id: 'utlandsmoms', text: 'Redovisar du moms i något annat land än Sverige?', disqualifyOn: true, reason: 'Enkla Bokslut är utvecklat för företag som endast redovisar svensk moms. Redovisning i flera länder innebär andra regler och deklarationer som inte ingår i tjänsten.', help: 'Osäker? Den här frågan gäller främst företag som säljer till privatpersoner i andra EU-länder eller är momsregistrerade utanför Sverige.' },
];
