...
const landingFaqItems = [
  { q: 'Vem passar Enkla Bokslut för?', a: 'Enkla Bokslut är byggt för Sveriges småföretagare. Vi riktar oss till enskilda firmor utan anställd personal och med en årsomsättning på upp till 3 miljoner kronor.\n\nTyvärr passar Enkla Bokslut inte alla verksamheter. I dagsläget kan vi inte hjälpa företag som har anställd personal, bedriver skogs- eller lantbruksverksamhet, driver taxiverksamhet eller har annan verksamhet med särskilt komplexa skatte- och momsregler.' },
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 sm:p-9">
          {sent ? (
            <div className="text-center py-8">
              ...
              <button
                onClick={() => { setSent(false); setName(''); setEmail(''); setPhone(''); setNotes(''); }}
