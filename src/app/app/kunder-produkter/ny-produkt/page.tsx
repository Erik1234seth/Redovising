...
export default function NyProduktPage() {
  const { user } = useAuth();
  ...
  return (
    <div className="flex flex-col min-h-full bg-slate-50">
      ...
      <div className="px-8 pt-12 pb-6">
        ...
        <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">Ny produkt</h1>
        <p className="text-slate-400 text-sm mt-2">Lägg till en produkt eller tjänst</p>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <input
                ...
                className={inputCls} style={ringStyle} autoFocus
              />
            </div>
